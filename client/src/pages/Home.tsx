...
const features = [
  {
    title: "Clientes",
    description:
      "Cadastre clientes e acompanhe contatos, negociações e histórico.",
    icon: Users,
  ...
  },
  {
    title: "Empréstimos",
    description:
      "Controle valores emprestados, juros, parcelas, pagamentos e saldo.",
    icon: HandCoins,
  ...
  },
  {
    title: "Veículos",
    description:
      "Cadastre veículos, acompanhe negociações, vendas e financiamentos.",
    icon: CarFront,
  ...
  },
  {
    title: "Produtos",
    description:
      "Organize produtos vendidos, valores, parcelamentos e recebimentos.",
    icon: Package,
  ...
  },
  {
    title: "Imóveis",
    description:
      "Cadastre casas, apartamentos, terrenos e lojas, com endereço, área, cômodos, garagem, preço e outras informações.",
    icon: Building2,
  ...
  },
  {
    title: "Aluguéis",
    description:
      "Selecione o imóvel e o cliente, defina aluguel, vencimento e acompanhe os recebimentos mensais.",
    icon: KeyRound,
  ...
  },
  {
    title: "Pagamentos",
    description:
      "Registre pagamentos recebidos e acompanhe o que já foi quitado.",
    icon: WalletCards,
  ...
  },
  {
    ...
    description:
      "Acompanhe vendas financiadas de veículos, produtos e imóveis, com parcelas, saldos e vencimentos.",
    icon: ClipboardList,
  ...
  },
  {
    ...
    description:
      "Veja o que falta receber, o que venceu e o que está atrasado.",
    icon: CalendarClock,
  ...
  },
  {
    title: "Caixa",
    description:
      "Tenha controle das entradas, saídas e do dinheiro disponível em toda a operação.",
    icon: Wallet,
  ...
  },
  {
    title: "Relatórios",
    description:
      "Consulte indicadores e relatórios para entender melhor o seu negócio.",
    icon: BarChart3,
...
const benefits = [
  {
    ...
    description:
      "Tenha clientes, vendas, empréstimos, imóveis e acordos registrados e fáceis de encontrar.",
    icon: CheckCircle2,
  },
  {
    title: "Controle parcelas e recebimentos",
    description:
      "Saiba o que já recebeu, o que ainda falta e o que está vencido.",
    icon: CalendarClock,
  },
  {
    title: "Acompanhe o dinheiro investido",
    description:
      "Veja quanto você colocou no negócio, quanto voltou e o que ainda está na rua.",
    icon: HandCoins,
  },
  {
    title: "Administre imóveis e aluguéis",
    description:
      "Controle imóveis disponíveis, alugados, financiados, vendidos e os recebimentos de cada contrato.",
    icon: Building2,
  },
  {
    title: "Tenha visão do caixa",
    description:
      "Veja entradas, saídas e relatórios para tomar decisões com mais informação.",
    icon: TrendingUp,
  },
];
...
const ads = [
  {
    ...
    description:
      "Controle juros, parcelas, vencimentos, pagamentos e saldo de cada cliente sem depender de caderno.",
    icon: HandCoins,
  ...
  },
  {
    ...
    title:
      "Aluga casas, apartamentos ou lojas? O Note Note também é para você.",
    description:
      "Cadastre o imóvel e o inquilino, defina o valor e o vencimento e acompanhe aluguel pago, pendente ou atrasado mês a mês.",
    icon: KeyRound,
  ...
  },
  {
    ...
    description:
      "Cadastre o veículo, registre entrada, parcelas, recebimentos e acompanhe o financiamento até a quitação.",
    icon: CarFront,
  ...
  },
  {
    ...
    description:
      "Gerencie imóveis, compradores, entrada, juros, parcelas e recebimentos com integração ao caixa.",
    icon: Building2,
  ...
  },
  {
    ...
    description:
      "Cadastre produtos, clientes, parcelas e pagamentos e veja tudo refletido no seu caixa.",
    icon: Package,
  ...
  },
  {
    ...
    description:
      "Empréstimos, vendas, financiamentos e aluguéis movimentam seu caixa para você enxergar a operação inteira.",
    icon: Wallet,
      ...
      <div className="relative overflow-hidden rounded-[2rem] border border-white/25 bg-white/15 p-5 shadow-2xl backdrop-blur-md sm:p-6">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-extrabold text-white">{ad.visualTitle}</p>
            </div>
          </div>
          <div className="rounded-full border border-white/20 bg-white/10 px-3 py-1 text-[10px] font-bold uppercase tracking-wide text-white/80">
            Ao vivo
          </div>
        </div>
            ...
            {isRental || isProperty ? (
              <div className="absolute inset-0 flex items-end justify-center">
                <div className="relative mb-4 flex h-28 w-[78%] items-end justify-center rounded-t-[2rem] border border-white/30 bg-white/15 backdrop-blur-sm">
                  ...
                  {isRental && (
                    <div className="absolute right-4 top-4 flex h-12 w-12 items-center justify-center rounded-full bg-white text-teal-700 shadow-lg">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="flex h-28 w-28 items-center justify-center rounded-[2rem] border border-white/25 bg-white/15 shadow-xl">
        ...
        <div className="mt-4 grid grid-cols-[1fr_auto] items-end gap-4 rounded-2xl bg-white p-4 text-slate-900 shadow-xl">
          <div>
            ...
            <p className="mt-1 text-lg font-black">Controle centralizado</p>
          </div>
          <div className="text-right">
            <p className="text-xl font-black text-blue-700">{ad.metric}</p>
...
function RotatingAds() {
  ...
  return (
    <section
      aria-label="Destaques do Note Note"
    ...
    >
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] border border-slate-200 bg-slate-950 shadow-xl">
        <div
          className={`relative min-h-[390px] overflow-hidden bg-gradient-to-br ${ad.accent} px-7 py-9 text-white sm:px-10 lg:px-14 lg:py-12`}
        >
          ...
          <div className="relative grid items-center gap-9 lg:grid-cols-[.95fr_1.05fr]">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-xs font-extrabold uppercase tracking-[0.18em]">
                <Icon className="h-4 w-4" /> {ad.eyebrow}
              </div>
              ...
              {ad.eyebrow === "Aluguel de imóveis" && (
                <div className="mt-5 inline-flex items-center gap-2 rounded-xl border border-white/20 bg-white/10 px-4 py-3 text-sm font-bold">
                  <HomeIcon className="h-5 w-5" /> Ideal para quem possui
                  imóveis e recebe aluguel.
                </div>
              )}
              <Link href="/planos">
                <a className="mt-7 inline-flex h-12 items-center gap-2 rounded-xl bg-white px-6 font-extrabold text-slate-900 shadow-lg transition hover:-translate-y-0.5">
                  Conhecer o Note Note <ArrowRight className="h-4 w-4" />
                </a>
              </Link>
            </div>
            <AdVisual ad={ad} />
          ...
          <div className="relative mt-8 flex flex-wrap items-center gap-2">
            {ads.map((item, index) => (
              <button
                key={item.eyebrow}
                type="button"
                aria-label={`Ver anúncio ${index + 1}: ${item.eyebrow}`}
                onClick={() => setActive(index)}
                className={`h-2.5 rounded-full transition-all ${index === active ? "w-9 bg-white" : "w-2.5 bg-white/40 hover:bg-white/70"}`}
              />
            ))}
          </div>
        </div>
          ...
          <div className="grid min-h-[390px] grid-cols-[130px_1fr] sm:grid-cols-[155px_1fr]">
            <aside className="border-r border-slate-100 bg-slate-50 p-3">
              ...
              {[
                ...
                <div
                  key={item}
                  className="px-2 py-1.5 text-[10px] font-medium text-slate-500 sm:text-[11px]"
                >
                  {item}
                </div>
              ))}
                ...
                <div className="rounded-xl border border-slate-100 p-3 shadow-sm">
                  ...
                  <div className="space-y-1.5 text-[9px] text-slate-500">
                    <div className="flex justify-between">
                      <span>Recebido</span>
                      <strong className="text-slate-700">R$ 22.180</strong>
                    </div>
                    <div className="flex justify-between">
                      <span>A receber</span>
                      <strong className="text-slate-700">R$ 48.750</strong>
                    </div>
                    <div className="flex justify-between">
                      <span>Aluguéis</span>
                      <strong className="text-slate-700">R$ 8.420</strong>
                    </div>
                  </div>
                </div>
              </div>
...
export default function Home() {
  ...
  useEffect(() => {
    fetch("/api/site-access?scope=reviews&action=published", {
      cache: "no-store",
    })
      .then(r => (r.ok ? r.json() : null))
      .then(j => {
        if (j?.success && Array.isArray(j.reviews)) setPublicReviews(j.reviews);
      })
      .catch(() => {});
  }, []);
  return (
    <div className="min-h-screen bg-white text-slate-950">
      <div className="bg-slate-950 px-4 py-2.5 text-center text-xs font-extrabold uppercase tracking-[0.16em] text-white sm:text-sm">
        Fez um rolo? Deu negócio?{" "}
        <span className="text-sky-300">Controle seus recebimentos.</span>
      </div>
      <header className="sticky top-0 z-50 border-b border-blue-100/70 bg-white/95 backdrop-blur-xl">
        <div className="mx-auto flex h-[76px] max-w-7xl items-center justify-between px-5 lg:px-8">
          ...
          <nav className="hidden items-center gap-8 text-sm font-semibold text-slate-700 md:flex">
            <a href="#recursos" className="transition hover:text-blue-600">
              Recursos
            </a>
            ...
            <Link href="/planos">
              <a className="transition hover:text-blue-600">Planos</a>
            </Link>
            <a href="#suporte" className="transition hover:text-blue-600">
              Suporte
            </a>
          </nav>
          <div className="flex items-center gap-2">
            <Link href="/login">
              <a className="inline-flex h-11 items-center justify-center rounded-xl border border-blue-200 bg-white px-3 text-sm font-bold text-blue-700 transition hover:bg-blue-50 sm:px-4">
                Login
              </a>
            </Link>
            <Link href="/cadastro?plano=free">
              <a className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-blue-600 px-3 text-sm font-bold text-white shadow-lg shadow-blue-600/20 transition hover:-translate-y-0.5 hover:bg-blue-700 sm:px-5">
                Cadastre-se grátis{" "}
      ...
      <main>
        <section
          id="inicio"
          className="relative overflow-hidden bg-gradient-to-br from-white via-blue-50/80 to-sky-100/80"
        >
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-5 py-16 lg:grid-cols-[.9fr_1.1fr] lg:px-8 lg:py-24">
            <div>
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-200 bg-white/80 px-4 py-2 text-sm font-semibold text-blue-900 shadow-sm">
                <span className="text-blue-600">★</span>Feito para quem vende,
                empresta, aluga e negocia no dia a dia
              </div>
              <h1 className="max-w-3xl text-4xl font-black leading-[1.04] tracking-tight text-slate-950 sm:text-5xl lg:text-[64px]">
                Organize tudo o que movimenta o seu negócio{" "}
                <span className="text-blue-600">em um só lugar.</span>
              </h1>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
                O Note Note reúne clientes, empréstimos, veículos, produtos,
                imóveis, aluguéis, vendas financiadas, pagamentos, contas a
              ...
              <div className="mt-9 grid gap-3 text-sm font-medium text-slate-600 sm:grid-cols-3">
                <div className="flex items-center gap-2">
                  <ShieldCheck className="h-5 w-5 text-blue-600" /> Acesso por
                  usuário
                </div>
                <div className="flex items-center gap-2">
                  <Cloud className="h-5 w-5 text-blue-600" /> Acesse pela
                  internet
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="h-5 w-5 text-blue-600" /> Simples de
                  usar
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-5 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 text-base leading-7 text-slate-600">
                Uma visão simples do que você vendeu, emprestou, alugou,
                financiou, recebeu e ainda tem para receber.
              </p>
            </div>
        ...
        <section
          id="imoveis"
          className="scroll-mt-24 border-y border-blue-100 bg-gradient-to-br from-slate-50 to-blue-50/60 py-20"
        >
          <div className="mx-auto max-w-7xl px-5 lg:px-8">
            <div className="grid items-center gap-10 lg:grid-cols-[.85fr_1.15fr]">
              <div>
                ...
                <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-950 sm:text-4xl">
                  Venda, financie e alugue imóveis dentro do Note Note.
                </h2>
                <p className="mt-5 text-base leading-8 text-slate-600">
                  Cadastre o patrimônio, acompanhe o cliente, registre contratos
                  e mantenha os recebimentos ligados ao seu caixa. O Note Note
                  também foi pensado para quem possui imóveis e recebe aluguel.
                </p>
              </div>
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-500">
                    Casa, apartamento, terreno ou loja, com endereço, tamanho,
                    cômodos, quartos, salas, cozinha, banheiros, garagem, preço
                    e observações.
                  </p>
                </div>
                <div className="rounded-2xl border border-teal-200 bg-teal-50 p-6 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    Vincule imóvel e inquilino, defina valor e dia de pagamento
                    e acompanhe mensalmente o que foi pago, pendente ou
                    atrasado.
                  </p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-500">
                    Venda à vista ou financie casas, apartamentos, terrenos e
                    lojas, com entrada, juros, parcelas, saldo e acompanhamento
                    do contrato.
                  </p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                  ...
                  <h3 className="mt-4 font-extrabold text-slate-900">
                    Tudo movimenta o caixa
                  </h3>
                  <p className="mt-2 text-sm leading-6 text-slate-500">
                    Recebimentos de aluguel, entradas, parcelas de financiamento
                    e vendas de imóveis entram no controle financeiro da
                    operação.
                  </p>
                </div>
              </div>
              ...
              {benefits.map(benefit => {
                ...
                return (
                  <div key={benefit.title} className="text-center lg:text-left">
                    ...
                    <h3 className="mt-4 text-sm font-extrabold leading-5 text-slate-900">
                      {benefit.title}
                    </h3>
                    <p className="mt-2 text-sm leading-6 text-slate-500">
                      {benefit.description}
        ...
        <section
          id="sobre"
          className="scroll-mt-24 border-t border-blue-100 bg-slate-50/70 py-20"
        >
          <div className="mx-auto grid max-w-7xl gap-12 px-5 lg:grid-cols-2 lg:px-8">
            <div>
              <p className="text-sm font-bold uppercase tracking-[0.18em] text-blue-600">
                Para quem é o Note Note?
              </p>
              <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-950 sm:text-4xl">
                Para quem trabalha fazendo negócio e precisa saber onde o
                dinheiro está.
              </h2>
            </div>
            <div className="space-y-5 text-base leading-8 text-slate-600">
              <p>
                O Note Note foi pensado para quem vende produtos, negocia
                veículos e imóveis, administra aluguéis, faz empréstimos
                pessoais ou trabalha com vendas parceladas e precisa enxergar
                quanto tem investido, quanto já recebeu e quanto ainda falta
                voltar.
              </p>
              <p>
                Em vez de espalhar informação em caderno, conversa de WhatsApp e
                planilhas diferentes, você concentra a operação em um único
                sistema e acompanha cada cliente e negociação de forma
                organizada.
              </p>
            </div>
          </div>
            ...
            <div className="mx-auto max-w-7xl px-5 lg:px-8">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mt-4 text-slate-600">
                  Avaliações enviadas por clientes do Note Note e publicadas
                  após análise.
                </p>
              </div>
                  ...
                  >
                    <div className="flex gap-1">
                      {[1, 2, 3, 4, 5].map(n => (
                        <Star
                          key={n}
                          className={`h-5 w-5 ${n <= Number(review.rating) ? "fill-amber-400 text-amber-400" : "text-slate-200"}`}
                        />
                      ))}
                    </div>
                    ...
                    <p className="mt-5 font-extrabold text-slate-900">
                      {review.name || "Cliente Note Note"}
                    </p>
                    <p className="text-xs text-slate-400">Cliente Note Note</p>
                  </article>
                ))}
              </div>
            </div>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-5 py-8 text-sm text-slate-500 sm:flex-row sm:items-center sm:justify-between lg:px-8">
          ...
          />
          <p>
            Note Note — gestão simples para quem vende, empresta, aluga e
            negocia.
          </p>
        </div>
      </footer>
