...
const quickTopics = ["Como começar?", "Dashboard", "Cadastrar cliente", "Empréstimos", "Produtos e estoque", "Veículos", "Financiamento", "Imóveis", "Financiar imóvel", "Aluguéis", "Pagamentos", "Agentes", "Caixa", "Contas a receber", "Meu Perfil"];
